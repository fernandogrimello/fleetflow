...
export async function updateLocation(req: Request, res: Response): Promise<void> {
  try {
    ...
    const result = await telemetryService.updateLocation(req.params.equipmentId, data)
    res.json(result)
  } catch (error) {
...
export async function getLastLocation(req: Request, res: Response): Promise<void> {
  try {
    const result = await telemetryService.getLastLocation(req.params.equipmentId)
    res.json(result)
  } catch (error) {
